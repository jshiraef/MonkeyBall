...
{
	float dist = zfar*cos(45.0f); //zfar distance to the corners of the hitbox
	float th = 1.0f / 3.0f; // 1/3 texture coordinates
	float of = (1.0f / 1024.0f) / 2; //offset of 1/2 texel
